      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                logquesAns[quiz.currentQuesIndex].question,
              ...
              ...logquesAns[quiz.currentQuesIndex].shuffledOptions.map((ans) {
                return Answerbutton(
                  answer: ans,
                  onTapAnswer: () {
                    if (quiz.isLastQuestion(logquesAns.length)) {
                      quiz.selectAnswer(
                        logquesAns[quiz.currentQuesIndex],
                        ans,
                      );
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (_) => ResultScreen(
                            totalQuestions: logquesAns.length,
                          ),
                        ),
                      );
                    } else {
