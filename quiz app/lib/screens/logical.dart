...
class Logical extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (quiz.currentQuesIndex >= logquesAns.length) {
      return const Scaffold(body: Center(child: CircularProgressIndicator()));
    }

    final question = logquesAns[quiz.currentQuesIndex];
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.white, Color.fromARGB(255, 196, 244, 244)],
                  ...
                  onTapAnswer: () {
                    ...
                    if (quiz.currentQuesIndex == logquesAns.length) {
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              ResultScreen(totalQuestions: logquesAns.length),
                        ),
                      );
                    }
                  },
